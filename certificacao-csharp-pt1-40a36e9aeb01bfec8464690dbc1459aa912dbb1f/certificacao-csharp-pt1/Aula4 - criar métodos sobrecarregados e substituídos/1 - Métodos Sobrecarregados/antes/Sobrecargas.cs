...
namespace certificacao_csharp_roteiro.antes
{
    class Sobrecargas : IAulaItem
    {
        ...
        //double VolumeDoCubo(double lado)
        //{
        //    return Math.Pow(lado, 3);
        //}

        //double VolumeDoCilindro(double altura, double raio)
        //{
        //    return altura * Math.PI * Math.Pow(raio, 2);
        //}

        //double VolumeDoPrisma(double largura, double profundidade, double altura)
        //{
        //    return largura * profundidade * altura;
        //}
    }
